...
import { Box, Button, Heading, HStack, IconButton, Image, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFocusScope, ModalFooter, ModalHeader, ModalOverlay, Text, useColorMode, useColorModeValue, useDisclosure, useToast, VStack } from '@chakra-ui/react'
    ...
    bg={bg}
     ...
     <Box p={4} textAlign={{
        ...
        <HStack spacing={2}>
            ...
            <IconButton icon={<DeleteIcon/>} onClick={()=>handleDeleteButton(product._id)} colorScheme='red'/>
